...
public class AssignmentTwo {
    ...
    public static void main(String[] args) throws IOException {
        ...
        if (args[2].equalsIgnoreCase("rhc")) {
            ...
            oa = new SimulatedAnnealing(Math.pow(10,10), Double.parseDouble(args[4]), nnop);
            ...
            System.out.printf("Running %s\n" +
                    ...
                    selected, Integer.parseInt(args[3]), Integer.parseInt(args[4]), Integer.parseInt(args[5]));
    ...
    private static void train(OptimizationAlgorithm oa, BackPropagationNetwork network, String oaName) throws IOException {
        ...
        for (int i = 0; i < trainingIterations; i++) {
            if (oaName.equalsIgnoreCase("random hill climbing") && i > 0 && i % (trainingIterations / 6) == 0 && i < 1900){
                ((RandomizedHillClimbing)oa).restart();
            }
            oa.train();
