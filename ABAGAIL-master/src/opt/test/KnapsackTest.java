...
public class KnapsackTest {
    ...
    public static void main(String[] args) throws IOException {
        ...
        start = System.nanoTime();
        SimulatedAnnealing sa = new SimulatedAnnealing(2000, .8, hcp);
        ...
        start = System.nanoTime();
        StandardGeneticAlgorithm ga = new StandardGeneticAlgorithm(200, 190, 10, gap);
        ...
        start = System.nanoTime();
        MIMIC mimic = new MIMIC(400, 2, pop);
